...
describe('VendingMachine', () => {
    ...
    beforeEach(() => {
        vm = new vending_machine_1.VendingMachine(initialProducts);
    });
    // Positive test cases
    ...
    describe('negative cases', () => {
        ...
        test('should handle insufficient funds', () => {
            ...
            const spy = jest.spyOn(console, 'log');
            vm.selectProduct('A1');
            expect(spy).toHaveBeenCalledWith('Insufficient balance. Soda costs 125 cents. Current balance: 25 cents.');
        });
